...
parser.add_argument(
    ...
    type=str,
    dest="test_data",
    help="CSV string containing test data",
)
...
# changes in the following lines as opposed to original code because data is inputted via argument (cfr. line 72) instead of input because of deprecation in helper.py script of Estimator

# Access the test data passed as CSV string
test_data_csv = args.test_data

# Load the test data from the CSV string
