...
def run_inference(
    ...
    script_config = ScriptRunConfig(
        ...
        arguments=[
            ...
            "--test_data", test_dataset.to_pandas_dataframe().to_csv(),
        ],
    ...
    '''
    # this is deprecated, replace Estimator with ScriptRunConfig. This also has impact on --test_data as additional argument (so also in infer.py) instead of input.
    est = Estimator(
        source_directory=script_folder,
